...
def _destination_handoff_profile(destination: str) -> dict[str, Any]:
    ...
    profile: dict[str, Any] = {
        ...
        "expected_role": "Advisory analysis and scoped recommendations.",
        "truth_anchor": "Use provided `G-Codex-brain/ROADMAP.md` excerpt + supplied repo evidence.",
        "preflight_step": "Do not assume local shell access. If repo status is missing or stale, request a fresh `git status --short --branch` report from a local executor.",
        "can_assume": [
            "Prompt context and explicit mission scope.",
        ...
        profile.update(
            {
                ...
                "expected_role": "Repository advisory via GitHub artifacts (issues/PRs/refs), not local execution.",
                "truth_anchor": "Use linked GitHub refs plus `G-Codex-brain/ROADMAP.md` excerpt from the source repo.",
                "preflight_step": "Use supplied branch/status evidence from GitHub or request a local executor refresh when missing.",
                "can_assume": [
                    "GitHub repository/PR/issue context provided by links or refs.",
        ...
        profile.update(
            {
                ...
                "expected_role": "Bounded implementation in an alternate execution environment with explicit verification notes.",
                "truth_anchor": "Use pinned branch/ref + `G-Codex-brain/ROADMAP.md` intent + required acceptance checks.",
                "preflight_step": "Confirm branch/ref and workspace state first; call out any environment differences before execution.",
                "can_assume": [
                    "Isolated cloud workspace execution capability.",
                    "Ability to implement scoped code changes in that workspace.",
                ],
                "do_not_assume": [
                    "Perfect parity with local developer environment.",
